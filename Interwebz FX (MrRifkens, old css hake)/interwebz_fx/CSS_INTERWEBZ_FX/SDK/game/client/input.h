...
class CInput : public IInput //updated version, built from mac bin, darkcat
{
// Interface
public:
							CInput( void );
...
//	virtual		void		ClearInputButton( int bits ); //not in tf2
...
//	virtual		void		CAM_GetCameraOffset( Vector& ofs );
	...
	virtual		void		ClearInputButton( int bits ); //moved to here
	...
	virtual		void		CAM_CapYaw( float shit );
	virtual		void		AdjustYaw( float shit, QAngle &bullshit );
...
private:
	...
	//void		AdjustYaw( float speed, QAngle& viewangles ); //moved to public
...
private:
	...
	bool		m_fJoystickAdvancedInit; //6
	...
	float		m_flKeyboardSampleTime; // 6+ 6*4
...
public: //Made public to meet the needs of external verification
